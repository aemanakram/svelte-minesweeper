...
var app = (function () {
    ...
    // (155:12) {#if mine.isRevealed && mine.isMine}
    	...
    	return {
    		c: function create() {
    			...
    			attr(button, "class", button_class_value = "field " + (ctx.mine.isRevealed ? 'open' : '') + " " + (ctx.mine.isMine
                  ? 'mine'
                  : '') + " svelte-bt0416");
    			add_location(button, file$1, 148, 10, 3429);
    ...
    // (146:4) {#each minefield as minerow}
    function create_each_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t = space();
    			attr(div, "class", "row svelte-bt0416");
    			add_location(div, file$1, 146, 6, 3367);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(button, "class", "reset-button svelte-bt0416");
    			add_location(button, file$1, 125, 6, 2881);
    			attr(div0, "class", "status svelte-bt0416");
    			add_location(div0, file$1, 131, 6, 3045);
    			attr(div1, "class", "status-bar svelte-bt0416");
    			add_location(div1, file$1, 124, 4, 2849);
    			attr(div2, "class", "container");
    			add_location(div2, file$1, 123, 2, 2820);
    			attr(main, "class", "svelte-bt0416");
    			add_location(main, file$1, 122, 0, 2810);
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      onMount(() => {
        $$invalidate('minefield', minefield = setupField(fieldSize, mineCount));
      });

    	function click_handler() {
    	          minefield = setupField(fieldSize, mineCount); $$invalidate('minefield', minefield);
    	        }
